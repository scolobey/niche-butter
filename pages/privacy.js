...
const Privacy = () => {
  ...
  return (
    <div>
      <Head>
        <title>NicheButter | Privcy Policy</title>
      </Head>

      <div className="text-content">
        <h1>Privacy Policy</h1>

        <p>NicheButter was designed and built by Ryan goodwin.&nbsp;</p>
        <p>This page is used to inform visitors of my policies with regards to the collection, use, and disclosure of Personal Information for anyone who decides to use the NicheButter Service.</p>
        ...
        <p>The app uses Stripe, a third party service that may collect information used to identify you.</p>
        <div>
        ...
        <p>This Service does not use these &ldquo;cookies&rdquo; explicitly. However, the app may use third party code and libraries that use &ldquo;cookies&rdquo; to collect information and improve their services.&nbsp;</p>
